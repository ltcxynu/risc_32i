...
# DVE full session
# Saved on Sun Oct 6 16:28:55 2024
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 284} {height 756} {dock_state left} {dock_on_new_line true} {child_hier_colhier 242} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 298} {height 756} {dock_state left} {dock_on_new_line true} {child_data_colvariable 251} {child_data_colvalue 52} {child_data_coltype 124} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 671]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 2487
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 671
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2487} {height 670} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMEXE {/home/host/risc_32i/src/rtl/coretb/simv}
