#UVM_HOME = /opt/synopsys/vcs201809/etc/uvm-1.2
#VCS_HOME = /opt/synopsys/vcs201809/bin
#VERDI_HOME = /opt/synopsys/vcs201809/bin/
...
comp:
	$(VCS) 	-f filelist.f							\
			./tb/compliance_test/tinyriscv_soc_tb.v \
			-l ./cmp.log
...
clean:
	rm -rf coverage.vdb csrc DVEfiles inter.vpd simv simv.daidir ucli.key vc_hdrs.h vcs.log .inter.vpd.uvm verdiLog driver_direct_testbench novas.rc novas.conf test.fsdb vcdplus.vpd *.log
	ls 
